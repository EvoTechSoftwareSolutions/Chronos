  ...
  return (
    <nav className="fixed top-0 left-0 w-full z-50 py-6 px-16 flex justify-between items-center bg-black/50 backdrop-blur-md border-b border-white/10 transition-all duration-300">
      ...
      <ul className="flex space-x-12 text-white text-lg tracking-wide">
        <li className="text-[#D4AF37] border-b-2 border-[#D4AF37] pb-1 cursor-pointer font-medium">Home</li>
        <li className="hover:text-[#D4AF37] pb-1 cursor-pointer transition text-gray-200">Collection</li>
        <li className="hover:text-[#D4AF37] pb-1 cursor-pointer transition text-gray-200">About</li>
        <li className="hover:text-[#D4AF37] pb-1 cursor-pointer transition text-gray-200">Contact</li>
      </ul>
      ...
      <div className="flex space-x-5 relative">
        ...
        {/* Cart Icon */}
        <button className="w-11 h-11 rounded-full border border-[#D4AF37] flex items-center justify-center text-[#D4AF37] hover:bg-[#D4AF37] hover:text-black transition duration-300 group">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5 group-hover:scale-110 transition-transform">
