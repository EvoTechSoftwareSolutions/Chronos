    ...
    <div className="bg-black text-white w-full min-h-screen">
      ...
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          <h4 className="text-[#D4AF37] uppercase tracking-widest text-sm mb-4 font-serif">Our Story</h4>
          <h1 className="text-5xl md:text-7xl font-serif tracking-wide mb-6">ABOUT US</h1>
